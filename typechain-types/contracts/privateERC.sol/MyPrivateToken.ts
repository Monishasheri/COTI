...
export interface MyPrivateTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface MyPrivateToken extends BaseContract {
  connect(runner?: ContractRunner | null): MyPrivateToken;
  waitForDeployment(): Promise<this>;

  interface: MyPrivateTokenInterface;
